...
{
    [SerializeField] private GameObject[] _turretPreview1;
    [SerializeField] private GameObject[] _turretPreviewRed1;
    ...
    private void Update()
    {
        ...
        {
            _turretPreviewRed = _turretPreviewRed1[1];
            _turretPreview = _turretPreview1[1];
            _turret = _turret1[1];
        }
        if (Input.GetKeyDown(KeyCode.Q))
        {
            _turretPreviewRed = _turretPreviewRed1[0];
            _turretPreview = _turretPreview1[0];
            _turret = _turret1[0];
        }
